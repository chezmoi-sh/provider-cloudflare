...
type ZoneInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/chezmoi-sh/provider-cloudflare/apis/account/v1alpha1.Account
	// +crossplane:generate:reference:refFieldName=ID
	...
	ID *v1.Reference `json:"id,omitempty" tf:"-"`
